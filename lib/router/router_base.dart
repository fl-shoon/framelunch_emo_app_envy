...
import 'package:emo_app_envy/router/router_not_found.dart';
...
class AppRouterDelegate extends RouterDelegate<RouterObject> with PopNavigatorRouterDelegateMixin {
  ...
  final List<Page> Function(RouterObject state) pageBuilder;
  ...
  AppRouterDelegate({
    ...
    _sub = stream.where((event) => event is RouterChangedEvent /* || event is RouterProcessEvent*/).listen((value) {
  ...
  Widget build(BuildContext context) {
    final _pages = pageBuilder(currentConfiguration!);
